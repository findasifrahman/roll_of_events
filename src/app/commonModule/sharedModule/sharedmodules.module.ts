...
@NgModule({
  imports: [
    ...
    OwlDateTimeModule,
    OwlNativeDateTimeModule,NgxLoadingModule,NgxMatSelectSearchModule,NgxPrintModule,
  ...
  exports: [
    ...
    NgbModule, CdkTableModule,//NgxMatSelectSearchModule,
    OwlDateTimeModule,
    OwlNativeDateTimeModule,NgxLoadingModule,NgxMatSelectSearchModule,NgxPrintModule,MatTableExporterModule
  ]
})
