...
import {cnsdata } from './cnsdata'
import { CommonService } from '../common.service';

@Component({
  selector: 'app-cns-view',
  templateUrl: './cns-view.component.html',
  styleUrls: ['./cns-view.component.scss']
})
export class CnsViewComponent implements OnInit {
  ...
  search_type = ""
  clients: string[]
  constructor(private route: ActivatedRoute,public _router: Router,private service: CommonService,private eventService:EventService) {
