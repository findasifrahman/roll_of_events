...
export class EventAddComponent implements OnInit {
  ...
  constructor(private snackBar: MatSnackBar,  private cdref: ChangeDetectorRef, private eventService:EventService,
    private formBuilder: FormBuilder, private _router: Router,private eventModels:eventForm) { }
    ...
    ////////////
      ...
      relatedYear = []
      searchtext = ""
      mainuri = routeurls.BASE_API_URL + "/api/tmpUploads/"//"/api/uploads/"//"http://localhost:5020/api/uploads/";
      totalImageno = 1
  ...
  async FormSubmit() {
    ...
    this.eventService.Add(formValue).subscribe(data=>{
