import { Component,Input, Directive, ElementRef, EventEmitter, HostListener, OnInit, Output } from '@angular/core';
...
export class PreviewViewComponent implements OnInit {
  ...
  totalImageno = 1
  constructor(private elRef: ElementRef<HTMLImageElement>,private route: ActivatedRoute,public _router: Router) {
  ...
  ngOnInit(): void { 
    ...
    this.route.params.subscribe(params => {
     ...
     /* posts.idres.image1 = 
      ...
      posts.idres.image11 = 
      posts.idres.image12 = */
      posts.relatedyear = [{title:"Title 1", place: "All", date:"Sunday", tdate:"27 july12021",image1:"https://via.placeholder.com/160"},
      {title:"Title 2", place: "All", date:"Sunday", tdate:"27 july12021",image1:"https://via.placeholder.com/160"},
        {title:"Title 3", place: "All", date:"Sunday", tdate:"27 july12021",image1:"https://via.placeholder.com/160"}]
      posts.relatednews =[{title:"Title 1", place: "All", date:"Sunday", tdate:"27 july12021",image1:"https://via.placeholder.com/160"},{
        title:"Title 2", place: "All", date:"Sunday", tdate:"27 july12021",image1:"https://via.placeholder.com/160"},
        {title:"Title 3", place: "All", date:"Sunday", tdate:"27 july12021",image1:"https://via.placeholder.com/160"}]
